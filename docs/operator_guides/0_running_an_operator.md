...
> **CURRENT VERSION:**
> Aligned Operator [v0.18.0](https://github.com/yetanotherco/aligned_layer/releases/tag/v0.18.0)
...
```bash
git clone https://github.com/yetanotherco/aligned_layer.git --branch v0.18.0
cd aligned_layer
```
